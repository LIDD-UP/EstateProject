...
from AmericanRealEstate.items import RealtorPropertyIdItem


class RealtorPropertyWebSpider(scrapy.Spider):
    name = 'realtor_property_web'
    allowed_domains = ['realtor.com']

    def __init__(self,
                 start_urls=None, user_agent_list=None,scrapy_start_time=None,
                 *args, **kwargs):
        super(RealtorPropertyWebSpider, self).__init__(*args, **kwargs)
        print(start_urls)
    ...
    custom_settings = {
        "ITEM_PIPELINES": {
            'AmericanRealEstate.pipelines.RealtorRealtorPropertyIdPipeline': 301,
    ...
    def parse(self, response):
        ...
        for house in houses:
            ...
            realtor_property_id_item = RealtorPropertyIdItem()
            realtor_property_id_item['propertyId'] = x
            yield realtor_property_id_item
