...
from AmericanRealEstate.settings import web_realtor_search_criteria,realtor_user_agent_list
import re
...
class StatisticsRealtorHouseCountSpider(scrapy.Spider):
    ...
    start_urls = [url for url in web_realtor_search_criteria]
    count_user_agent_list = realtor_user_agent_list
