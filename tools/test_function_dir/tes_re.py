...
# test_source_str = "["https://www.realtor.com/realestateandhomes-search/New-York-County_NY"]"
# test_source_str_list = list(test_source_str)
# print(test_source_str_list)
# list = ["scrapy", "crawl", "realtor","-a","start_urls="https://www.realtor.com/realestateandhomes-search/New-York-County_NY""]

# 测试dict
import ast
# custom_settings = '{"ITEM_PIPELINES": {"AmericanRealEstate.pipelines.RealtorHouseInfoPipeline": 301},"DOWNLOADER_MIDDLEWARES":{"AmericanRealEstate.middlewares.AlertUserAgentWhenEncounter302Middleware": 545},"DEFAULT_REQUEST_HEADERS": {"authority": "www.realtor.com","method": "GET","scheme": "https","accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,","accept-encoding": "gzip, deflate, br","accept-language": "zh-CN,zh;q=0.9,ja;q=0.8","cache-control": "no-cache","upgrade - insecure - requests": "1","user-agent": "Opera/9.80 (X11; Linux i686; U; hu) Presto/2.9.168 Version/11.50"},"COOKIES_ENABLED": False,"REDIRECT_ENABLED": False}'

# print(custom_settings[630:645])
import json
# custom_settings = '''{
#         # "ITEM_PIPELINES": {
...
# import json
#
# # str = "{"params":{"id":222,"offset":0}}"
#
# # params = json.loads(custom_settings)
# str_dict = ast.literal_eval(custom_settings)
# print(type(str_dict))
# print(str_dict)
...
custom_settings_str = '''
{
        ...
        "DEFAULT_REQUEST_HEADERS": {
            ...
            # 'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36',
            # 'user-agent':'Opera/9.80 (X11; Linux x86_64; U; fr) Presto/2.9.168 Version/11.50',
            'user-agent': 'Opera/9.80 (X11; Linux i686; U; hu) Presto/2.9.168 Versversion',
            # 'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:25.0) Gecko/20100101 Firefox/25.0',
            # 'User-Agent': start_user_agent,
            # 'referer': 'www.realtor.com',
        },
...
'''
str_dict = ast.literal_eval(custom_settings_str)
print(type(str_dict))
print(str_dict)
# print(custom_settings_str)
